<?php
/**
 * BANDAR FIT - Single Page Application
 * @package BandarFit
 */
...
<body class="antialiased text-right">
    ...
    <main id="appContainer">
        ...
        <section id="ptView" class="view-content pt-40 pb-20 px-6 max-w-7xl mx-auto text-center">
            ...
            <!-- قسم مقاطع الرياضيين (تحت خطوات البداية) -->
            <div class="mb-32 text-center text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-center">
                    <div class="rounded-[2rem] overflow-hidden relative group aspect-video border border-white/5 text-center">
                        <img src="https://images.unsplash.com/photo-1544033527-b192daee1f5b?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition-all duration-700 brightness-75" alt="Athlete Drill 1">
                        <div class="absolute inset-0 video-overlay flex items-center justify-center text-center">
                            <div class="w-12 h-12 bg-brand/90 rounded-full flex items-center justify-center shadow-lg text-center text-center"><i data-lucide="play" class="text-dark w-5 h-5 fill-dark ml-1 text-center text-center"></i></div>
                        </div>
                    </div>
                    <div class="rounded-[2rem] overflow-hidden relative group aspect-video border border-white/5 text-center text-center">
                        <img src="https://images.unsplash.com/photo-1518611012118-2969c63700b7?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition-all duration-700 brightness-75" alt="Athlete Drill 2">
                        <div class="absolute inset-0 video-overlay flex items-center justify-center text-center">
                            <div class="w-12 h-12 bg-brand/90 rounded-full flex items-center justify-center shadow-lg text-center text-center"><i data-lucide="play" class="text-dark w-5 h-5 fill-dark ml-1 text-center"></i></div>
                        </div>
                    </div>
                    <div class="rounded-[2rem] overflow-hidden relative group aspect-video border border-white/5 text-center text-center">
                        <img src="https://images.unsplash.com/photo-1431324155629-1a6eda1eed15?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition-all duration-700 brightness-75" alt="Athlete Drill 3">
                        <div class="absolute inset-0 video-overlay flex items-center justify-center text-center">
                            <div class="w-12 h-12 bg-brand/90 rounded-full flex items-center justify-center shadow-lg text-center text-center"><i data-lucide="play" class="text-dark w-5 h-5 fill-dark ml-1 text-center"></i></div>
                        </div>
                    </div>
            ...
            <!-- كواليس صناعة الأبطال (التصميم الجانبي المطور) -->
        ...
        <section id="evalView" class="view-content pt-32 pb-20 px-6 max-w-7xl mx-auto text-center text-center text-center">
            ...
            <!-- قسم اختبارات رياضيين (جديد - تحت الألبوم) -->
            <div class="mb-32 text-center text-center text-center text-center text-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-center text-center text-center text-center">
                    <div class="rounded-[2rem] overflow-hidden relative group aspect-video border border-brand/20 shadow-lg shadow-brand/5 text-center">
                        <img src="https://images.unsplash.com/photo-1599447421416-3414500d18a5?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition-all duration-700 brightness-50" alt="Test Clip 1">
                        <div class="absolute inset-0 flex items-center justify-center text-center text-center">
                            <div class="w-12 h-12 bg-brand/80 rounded-full flex items-center justify-center shadow-lg text-center text-center"><i data-lucide="play" class="text-dark w-5 h-5 fill-dark ml-1 text-center"></i></div>
                        </div>
                        <div class="absolute bottom-3 right-4 text-right text-center text-center">
                            <p class="text-[8px] font-black uppercase text-brand italic text-center">اختبار القفز العمودي</p>
                        </div>
                    </div>
                    <div class="rounded-[2rem] overflow-hidden relative group aspect-video border border-brand/20 shadow-lg shadow-brand/5 text-center text-center">
                        <img src="https://images.unsplash.com/photo-1532384748853-8f54a8f476e2?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition-all duration-700 brightness-50" alt="Test Clip 2">
                        <div class="absolute inset-0 flex items-center justify-center text-center text-center text-center">
                            <div class="w-12 h-12 bg-brand/80 rounded-full flex items-center justify-center shadow-lg text-center text-center"><i data-lucide="play" class="text-dark w-5 h-5 fill-dark ml-1 text-center"></i></div>
                        </div>
                        <div class="absolute bottom-3 right-4 text-right text-center">
                            <p class="text-[8px] font-black uppercase text-brand italic text-center">تقييم المرونة الوظيفية</p>
                        </div>
                    </div>
                    <div class="rounded-[2rem] overflow-hidden relative group aspect-video border border-brand/20 shadow-lg shadow-brand/5 text-center text-center">
                        <img src="https://images.unsplash.com/photo-1517438476312-10d79c67750d?q=80&w=600" class="w-full h-full object-cover group-hover:scale-110 transition-all duration-700 brightness-50" alt="Test Clip 3">
                        <div class="absolute inset-0 flex items-center justify-center text-center text-center text-center">
                            <div class="w-12 h-12 bg-brand/80 rounded-full flex items-center justify-center shadow-lg text-center text-center text-center text-center"><i data-lucide="play" class="text-dark w-5 h-5 fill-dark ml-1 text-center"></i></div>
                        </div>
                        <div class="absolute bottom-3 right-4 text-right text-center">
                            <p class="text-[8px] font-black uppercase text-brand italic text-center text-center">اختبار الرشاقة الميداني</p>
                        </div>
                    </div>
                </div>
            </div>
